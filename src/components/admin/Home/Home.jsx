...
export default function Home() {
  ...
  useEffect(() => {
    fetch("http://localhost:3001/api/profile/me", { credentials: "include" })
      .then((res) => res.json())
  ...
  return (
    <div className="home-container">
      <Menu menus={menu_admin} currentUser={currentUser} />
      ...
      <div className="home-content">
        ...
        <ul className="home-list">
          <li>
            📌 Go to <strong>Course Management</strong> to view, add, edit and
            open courses.
          </li>
          <li>
          ...
          <li>
            📌 Go to <strong>Account Management</strong> to view, add and edit
            accounts.
          </li>
          <li>
